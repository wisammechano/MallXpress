...
import com.edenxpress.mobi.Utils;
...
/**
 * Created by HP 15-P038 on Feb 24 17.
 */
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final float defaultStrokeWidth = Utils.dpToPx(1, context.getResources().getDisplayMetrics());
        final float defaultRadius = Utils.dpToPx(3, context.getResources().getDisplayMetrics());
    ...
    public boolean onTouchEvent(android.view.MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_UP:
                ...
                mLastMotionX = ev.getX(ev.findPointerIndex(mActivePointerId)); //MotionEventCompat.getX(ev, MotionEventCompat.findPointerIndex(ev, mActivePointerId));
                break;
        }
    ...
    public void setViewPager(ViewPager view) {
        ...
        if (mViewPager != null) {
            mViewPager.clearOnPageChangeListeners();//;setOnPageChangeListener(null);
        }
